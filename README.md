...
- **Мониторинг ресурсов**: В реальном времени отображается загрузка CPU и RAM сервера.
- **Гибкое управление хранилищами**: Возможность назначать любое подключенное хранилище основным (Default Storage).
